...
class k4a:
    def __init__(self):
        ...
        self.k4a_capture_set_color_image.argtypes = (
            k4a_capture_t,
            k4a_image_t,
        )
        ...
        self.k4a_capture_set_depth_image.argtypes = (
            k4a_capture_t,
            k4a_image_t,
        )
        ...
        self.k4a_capture_set_ir_image.argtypes = (
            k4a_capture_t,
            k4a_image_t,
        )
        ...
        self.k4a_capture_set_temperature_c.argtypes = (
            k4a_capture_t,
            k4a_image_t,
        )
        self.k4a_capture_set_temperature_c.argtypes = (
        ...
        self.k4a_image_create.argtypes = (
            k4a_image_format_t,
            ctypes.c_int,
            ctypes.c_int,
            ctypes.c_int,
        ...
        self.k4a_image_create_from_buffer.argtypes = (
            k4a_image_format_t,
            ctypes.c_int,
            ctypes.c_int,
            ctypes.c_int,
        ...
        self.k4a_image_set_device_timestamp_usec.argtypes = (
            k4a_image_t,
            ctypes.c_uint64,
        )
        ...
        self.k4a_image_set_timestamp_usec.argtypes = (
            k4a_image_t,
            ctypes.c_uint64,
        )
        ...
        self.k4a_image_set_system_timestamp_nsec.argtypes = (
            k4a_image_t,
            ctypes.c_uint64,
        )
        ...
        self.k4a_image_set_exposure_usec.argtypes = (
            k4a_image_t,
            ctypes.c_uint64,
        )
        ...
        self.k4a_image_set_exposure_time_usec.argtypes = (
            k4a_image_t,
            ctypes.c_uint64,
        )
        ...
        self.k4a_image_set_white_balance.argtypes = (
            k4a_image_t,
            ctypes.c_uint32,
        )
        ...
        self.k4a_image_set_iso_speed.argtypes = (
            k4a_image_t,
            ctypes.c_uint32,
        )
        ...
        self.k4a_device_start_cameras.argtypes = (
            k4a_device_t,
        ...
        self.k4a_device_get_version.argtypes = (
            k4a_device_t,
        ...
        self.k4a_device_get_color_control_capabilities.argtypes = (
            k4a_device_t,
        ...
        self.k4a_device_get_color_control.argtypes = (
            k4a_device_t,
            k4a_color_control_command_t,
            ctypes.POINTER(k4a_color_control_mode_t),
            ctypes.POINTER(ctypes.c_int32),
        ...
        self.k4a_device_set_color_control.argtypes = (
            k4a_device_t,
            k4a_color_control_command_t,
        ...
        self.k4a_device_get_raw_calibration.argtypes = (
            k4a_device_t,
            ctypes.POINTER(ctypes.c_uint8),
        ...
        self.k4a_device_get_calibration.argtypes = (
            k4a_device_t,
            k4a_depth_mode_t,
        ...
        self.k4a_device_get_sync_jack.argtypes = (
            k4a_device_t,
            ctypes.POINTER(ctypes.c_bool),
            ctypes.POINTER(ctypes.c_bool),
        )
        ...
        self.k4a_calibration_get_from_raw.argtypes = (
        ...
        self.k4a_calibration_3d_to_3d.argtypes = (
            ctypes.POINTER(k4a_calibration_t),
        ...
        self.k4a_calibration_2d_to_3d.argtypes = (
            ctypes.POINTER(k4a_calibration_t),
        ...
        self.k4a_calibration_3d_to_2d.argtypes = (
            ctypes.POINTER(k4a_calibration_t),
            ctypes.POINTER(k4a_float3_t),
            k4a_calibration_type_t,
            k4a_calibration_type_t,
        ...
        self.k4a_calibration_2d_to_2d.argtypes = (
            ctypes.POINTER(k4a_calibration_t),
            ctypes.POINTER(k4a_float2_t),
            ctypes.c_float,
            k4a_calibration_type_t,
        ...
        self.k4a_calibration_color_2d_to_depth_2d.argtypes = (
            ctypes.POINTER(k4a_calibration_t),
            ctypes.POINTER(k4a_float2_t),
            k4a_image_t,
            ctypes.POINTER(k4a_float2_t),
        ...
        self.k4a_transformation_depth_image_to_color_camera.argtypes = (
		...
		"""
        self.k4a_transformation_depth_image_to_color_camera_custom = (
            dll.k4a_transformation_depth_image_to_color_camera_custom
        )
        self.k4a_transformation_depth_image_to_color_camera_custom.restype = k4a_result_t
        self.k4a_transformation_depth_image_to_color_camera_custom.argtypes = (
            k4a_transformation_t,
            k4a_image_t,
            k4a_image_t,
            k4a_image_t,
        ...
        self.k4a_transformation_color_image_to_depth_camera.argtypes = (
            k4a_transformation_t,
            k4a_image_t,
            k4a_image_t,
            k4a_image_t,
        ...
        self.k4a_transformation_depth_image_to_point_cloud.argtypes = (
            k4a_transformation_t,
            k4a_image_t,
            k4a_calibration_type_t,
            k4a_image_t,
