...
class record:
    ...
    def create_recording(self, device_handle, device_configuration, filepath):
        _k4arecord.VERIFY(
            self.k4arecord.k4a_record_create(
                filepath.encode("utf-8"), device_handle, device_configuration, self.record_handle
            ),
    ...
    def write_capture(self, capture_handle):
        ...
        _k4arecord.VERIFY(
            self.k4arecord.k4a_record_write_capture(self.record_handle, capture_handle), "Failed to write capture!"
        )
