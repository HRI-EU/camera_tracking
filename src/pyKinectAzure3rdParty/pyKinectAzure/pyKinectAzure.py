...
class pyKinectAzure:
    ...
    def bodyTracker_start(self, bodyTrackerModulePath, modelType=_k4abt.K4ABT_DEFAULT_MODEL, model_directory=None):
        ...
        self.body_tracker = kinectBodyTracker(bodyTrackerModulePath, depthSensorCalibration, modelType, model_directory)
    ...
    def transform_depth_image_to_point_cloud(self, depth_image_handle: _k4a.k4a_image_t):
        ...
        _k4a.VERIFY(
            self.k4a.k4a_transformation_depth_image_to_point_cloud(
                transformation_handle, depth_image_handle, _k4atypes.K4A_CALIBRATION_TYPE_DEPTH, point_cloud
            ),
