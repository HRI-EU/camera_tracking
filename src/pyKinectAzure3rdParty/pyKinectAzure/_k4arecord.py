...
class k4arecord:
    def __init__(self, modulePath):
        ...
        self.k4a_record_create.argtypes = (
        ...
        self.k4a_playback_open.argtypes = (
            ctypes.POINTER(ctypes.c_char),
        ...
        self.k4a_playback_get_next_capture.argtypes = (
            k4a_playback_t,
        ...
        self.k4a_playback_get_previous_capture.argtypes = (
            k4a_playback_t,
            ctypes.POINTER(k4a_capture_t),
        )
        ...
        self.k4a_playback_get_calibration.argtypes = (
            k4a_playback_t,
