...
# Path to the module
modulePath = "/hri/storage/user/mgienger/install/AzureKinect/lib/libk4a.so"
bodyTrackingModulePath = "/hri/storage/user/mgienger/install/AzureKinect/lib/libk4abt.so.1.1.0"
...
def print_body_information(body):
    ...
    for i in range(_k4abt.K4ABT_JOINT_COUNT):
        ...
        print(
            "Joint[{}]: xPosition[mm] ( {}, {}, {} ); Orientation ( {}, {}, {}, {}); Confidence Level ({})".format(
                i,
                position.v[0],
                position.v[1],
                position.v[2],
