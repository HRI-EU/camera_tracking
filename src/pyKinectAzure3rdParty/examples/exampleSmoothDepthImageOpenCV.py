    ...
    while True:
        ...
        if depth_image_handle:
            ...
            comparison_image = cv2.putText(
                comparison_image, "Original", (180, 50), cv2.FONT_HERSHEY_SIMPLEX, 1.5, (255, 255, 255), 3, cv2.LINE_AA
            )
            comparison_image = cv2.putText(
                comparison_image, "Smoothed", (670, 50), cv2.FONT_HERSHEY_SIMPLEX, 1.5, (255, 255, 255), 3, cv2.LINE_AA
            )
